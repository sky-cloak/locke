...
[![Keycloak compatibility](https://img.shields.io/badge/Keycloak-26.7.1-blue)](./COMPATIBILITY.md)
...
docker run --rm -p 8080:8080 \
  ...
  ghcr.io/sky-cloak/locke:26.7.1-1 start-dev
...
|---|---|---|
| `26.7.1-1` | 26.7.1 | current |
| `26.7.0-1` | 26.7.0 | superseded |
| `26.6.4-4` | 26.6.4 | superseded |
...
[benchmark/k8s/REPORT.md](./benchmark/k8s/REPORT.md) (and
