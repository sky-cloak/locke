...
import org.keycloak.models.cache.redis.entities.CachedFederatedIdentityLinks;
import org.keycloak.models.cache.redis.entities.CachedUser;
import org.keycloak.models.cache.redis.entities.CachedUserConsent;
import org.keycloak.models.cache.redis.entities.CachedUserConsents;
import org.keycloak.models.cache.redis.entities.UserListQuery;
...
public class UserCacheSession implements UserCache, OnCreateComponent, OnUpdateComponent, UserProfileDecorator {
    ...
    // Verifiable credentials are delegated uncached; Redis-native caching is an optimization
    // tracked separately (docs/adr/0004: functional parity is the gate, caching parity is backlog).
    @Override
    ...
    public UserVerifiableCredentialModel getVerifiableCredentialByClientScope(String userId, String clientScopeId) {
        return getDelegate().getVerifiableCredentialByClientScope(userId, clientScopeId);
    }
