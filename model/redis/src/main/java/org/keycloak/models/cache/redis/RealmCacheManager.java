...
import org.keycloak.models.cache.redis.events.RealmCacheInvalidationEvent;
...
public class RealmCacheManager extends CacheManager {
    ...
    public RealmCacheManager(RedisCache<String, Revisioned> cache, RedisCache<String, Long> revisions) {
