...
import org.keycloak.models.cache.redis.events.UserCacheInvalidationEvent;
...
public class UserCacheManager extends CacheManager {
    ...
    public UserCacheManager(RedisCache<String, Revisioned> cache, RedisCache<String, Long> revisions) {
