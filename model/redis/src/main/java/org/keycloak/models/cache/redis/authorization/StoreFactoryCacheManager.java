...
import org.keycloak.models.cache.redis.CacheManager;
import org.keycloak.models.cache.redis.RealmCacheManager;
import org.keycloak.models.cache.redis.authorization.events.AuthorizationCacheInvalidationEvent;
...
public class StoreFactoryCacheManager extends CacheManager {
    ...
    public StoreFactoryCacheManager(RedisCache<String, Revisioned> cache, RedisCache<String, Long> revisions) {
