...
/**
 * Cached set of public keys plus the time they were last fetched. Mirror of the
 * Infinispan variant, kept in this package so it does not depend on model/infinispan
