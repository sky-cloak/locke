...
- Locke is a **Keycloak-compatible** distribution. We describe it that way.
- We do **not** imply endorsement by, sponsorship by, or affiliation with the
...
This mirrors how Adoptium Temurin refers to "Java/OpenJDK" and how Percona Server
...
- State that your project "uses Locke" or is "built on Locke."
- Redistribute Locke under the terms of the Apache License 2.0, keeping the name
  to refer to the unmodified distribution.

Please do not:

- Use "Locke" as the name of a modified distribution in a way that implies it is
  the official one. Rename modified builds.
- Use the Locke logo to imply Skycloak endorses your product.
